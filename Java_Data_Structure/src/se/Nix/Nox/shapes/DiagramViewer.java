...
public class DiagramViewer
{
    ...
    private static Rect getRandomRectangle() {
	return new Rect(rnd.nextInt(400), rnd.nextInt(400),rnd.nextInt(200), rnd.nextInt(200),getRandomColor());
    }

    private static Text getRandomText() {
	return new Text(rnd.nextInt(400), rnd.nextInt(400),rnd.nextInt(200), getRandomColor(), "Hello");
    }
